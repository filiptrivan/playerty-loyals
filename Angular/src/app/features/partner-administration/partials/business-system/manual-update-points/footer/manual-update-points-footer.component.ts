...
import { BusinessSystem, ManualUpdatePoints } from 'src/app/business/entities/business-entities.generated';
...
export class ManualUpdatePointsFooterComponent implements OnInit {
    ...
    scheduleJobManually(){
        ...
        this.apiService.manualUpdatePoints(this.manualUpdatePointsFormGroup.getRawValue()).subscribe(() => {
