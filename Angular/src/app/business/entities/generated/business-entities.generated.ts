...
export class NotificationPartnerUser extends BaseEntity
{
    isMarkedAsRead?: any;
...
export class RolePartnerUser extends BaseEntity
{
    rolesId?: number;
	partnerUsersId?: number;
