...
export class ValidatorBusinessService {
    ...
    getValidator(formControl: SoftFormControl, className: string): SoftValidatorFn {
        ...
        case 'getPurchasesEndpointStore':
            return this.getPurchasesEndpointStoreValidator(formControl);
        case 'getReversalsEndpointStore':
            return this.getReversalsEndpointStoreValidator(formControl);
        ...
        case 'transactionIdTransactionProduct':
            return this.transactionIdTransactionProductValidator(formControl);
    ...
    getPurchasesEndpointStoreValidator(control: SoftFormControl): SoftValidatorFn {
        const validator: SoftValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
        ...
        const stringLengthRule = (value?.length >= min && value?.length <= max) || (typeof value === 'undefined' || value === null || value === '');
            ...
            const getPurchasesEndpointValid = stringLengthRule;

            return getPurchasesEndpointValid ? null : { _ : this.translocoService.translate('Length', {min, max}) };
        };
        
        return validator;
    }

    getReversalsEndpointStoreValidator(control: SoftFormControl): SoftValidatorFn {
        const validator: SoftValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
        ...
        const stringLengthRule = (value?.length >= min && value?.length <= max) || (typeof value === 'undefined' || value === null || value === '');
            ...
            const getReversalsEndpointValid = stringLengthRule;

            return getReversalsEndpointValid ? null : { _ : this.translocoService.translate('Length', {min, max}) };
        };
    ...
    transactionIdTransactionProductValidator(control: SoftFormControl): SoftValidatorFn {
        const validator: SoftValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
            ...
            return transactionIdValid ? null : { _ : this.translocoService.translate('NotEmpty', {}) };
        };
        validator.hasNotEmptyRule = true;
        return validator;
    }
    ...
    userIdTransactionValidator(control: SoftFormControl): SoftValidatorFn {
        const validator: SoftValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
