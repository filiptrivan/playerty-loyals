...
export class ValidatorLoyalsService {
    ...
    getValidator(formControl: SoftFormControl, className: string): SoftValidatorFn {
        ...
        case 'discountStoreTierDiscountProductGroup':
            return this.discountStoreTierDiscountProductGroupValidator(formControl);
        ...
        case 'storeIdDiscountProductGroup':
            return this.storeIdDiscountProductGroupValidator(formControl);
    ...
    discountStoreTierDiscountProductGroupValidator(control: SoftFormControl): SoftValidatorFn {
        const validator: SoftValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
    ...
    storeIdDiscountProductGroupValidator(control: SoftFormControl): SoftValidatorFn {
        const validator: SoftValidatorFn = (): ValidationErrors | null => {
            const value = control.value;
