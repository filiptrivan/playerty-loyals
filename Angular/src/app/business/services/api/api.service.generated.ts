...
export class ApiGeneratedService extends ApiSecurityService {
    ...
    getSegmentationItemsForTheSegmentation = (segmentationId: number): Observable<SegmentationItem[]> => { 
        return this.http.get<SegmentationItem[]>(`${this.config.apiUrl}/Segmentation/GetSegmentationItemsForTheSegmentation?segmentationId=${segmentationId}`, this.config.httpOptions);
    }
