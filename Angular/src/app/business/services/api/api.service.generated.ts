...
export class ApiGeneratedService extends ApiSecurityService {
    ...
    saveSegmentation(segmentationSaveBodyDTO: SegmentationSaveBody): Observable<SimpleSaveResult> { 
        return this.http.put<SimpleSaveResult>(`${environment.apiUrl}/Segmentation/SaveSegmentation`, segmentationSaveBodyDTO, environment.httpOptions);
    }
