    ...
    translate(name: string): string
    {
        switch(name) 
        {
            ...
            case 'pointsForTheFirstTimeGenderFill':
                return this.translocoService.translate('PointsForTheFirstTimeGenderFill');
            case 'pointsForTheFirstTimeBirthDateFill':
                return this.translocoService.translate('PointsForTheFirstTimeBirthDateFill');
            ...
            case 'hasFilledGenderForTheFirstTime':
                return this.translocoService.translate('HasFilledGenderForTheFirstTime');
            case 'hasFilledBirthDateForTheFirstTime':
                return this.translocoService.translate('HasFilledBirthDateForTheFirstTime');
            case 'user':
