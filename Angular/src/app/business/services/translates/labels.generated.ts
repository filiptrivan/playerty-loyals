...
export class TranslateLabelsGeneratedService {
    ...
    translate(name: string): string
    {
        switch(name) 
        {
            ...
            case 'unselectedPartnerUsersIds':
                return this.translocoService.translate('UnselectedPartnerUsersIds');
            case 'areAllPartnerUsersSelected':
                return this.translocoService.translate('AreAllPartnerUsersSelected');
            case 'partnerUsersTableFilter':
                return this.translocoService.translate('PartnerUsersTableFilter');
