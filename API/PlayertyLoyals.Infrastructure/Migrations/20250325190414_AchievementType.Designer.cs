...
namespace PlayertyLoyals.Infrastructure.Migrations
{
    ...
    [Migration("20250325190414_AchievementType")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlayertyLoyals.Business.Entities.Achievement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PlayertyLoyals.Business.Entities.AchievementType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PlayertyLoyals.Business.Entities.BusinessSystem", b =>
                {
                    ...
                    b.Property<string>("GetDiscountProductGroupsEndpoint")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("PlayertyLoyals.Business.Entities.Transaction", b =>
                {
                    ...
                    b.Property<long>("BusinessSystemUpdatePointsScheduledTaskId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("BusinessSystemUpdatePointsScheduledTaskId");
            ...
            modelBuilder.Entity("PlayertyLoyals.Business.Entities.Achievement", b =>
                {
                    b.HasOne("PlayertyLoyals.Business.Entities.AchievementType", "AchievementType")
                    ...
                    b.HasOne("PlayertyLoyals.Business.Entities.Transaction", "Transaction")
                        .WithMany("Achievements")
            ...
            modelBuilder.Entity("PlayertyLoyals.Business.Entities.Transaction", b =>
                {
                    b.HasOne("PlayertyLoyals.Business.Entities.BusinessSystemUpdatePointsScheduledTask", "BusinessSystemUpdatePointsScheduledTask")
                        .WithMany("Transactions")
                        .HasForeignKey("BusinessSystemUpdatePointsScheduledTaskId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.Navigation("BusinessSystemUpdatePointsScheduledTask");
