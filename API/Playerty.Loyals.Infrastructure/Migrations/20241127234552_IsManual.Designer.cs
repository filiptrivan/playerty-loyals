...
namespace Playerty.Loyals.Infrastructure.Migrations
{
    ...
    [Migration("20241127234552_IsManual")]
    partial class IsManual
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Playerty.Loyals.Business.Entities.Store", b =>
                {
                    ...
                    b.Property<DateTime?>("UpdatePointsStartDatetime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Playerty.Loyals.Business.Entities.StoreUpdatePointsScheduledTask", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTime>("ShouldStartedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("StoreUpdatePointsScheduledTasks");
                });
            ...
            modelBuilder.Entity("Playerty.Loyals.Business.Entities.StoreTierDiscountCategory", b =>
                {
                    b.HasOne("Playerty.Loyals.Business.Entities.DiscountCategory", "DiscountCategory")
                        .WithMany("StoreTierDiscountCategories")
                        .HasForeignKey("DiscountCategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Playerty.Loyals.Business.Entities.StoreTier", "StoreTier")
                        .WithMany("StoreTierDiscountCategories")
                    ...
                    b.Navigation("StoreTier");
                });

            modelBuilder.Entity("Playerty.Loyals.Business.Entities.StoreUpdatePointsScheduledTask", b =>
                {
                    b.HasOne("Playerty.Loyals.Business.Entities.Store", "Store")
                        .WithMany("StoreUpdatePointsScheduledTasks")
                        .HasForeignKey("StoreId");
            ...
            modelBuilder.Entity("Playerty.Loyals.Business.Entities.DiscountCategory", b =>
                {
                    b.Navigation("StoreTierDiscountCategories");
                });
            ...
            modelBuilder.Entity("Playerty.Loyals.Business.Entities.Store", b =>
                {
                    ...
                    b.Navigation("StoreUpdatePointsScheduledTasks");
                });
