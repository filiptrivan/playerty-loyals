...
namespace Playerty.Loyals.Infrastructure.Migrations
{
    ...
    [Migration("20241123231051_GetDiscountCategoriesEndpoint")]
    partial class GetDiscountCategoriesEndpoint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Playerty.Loyals.Business.Entities.Store", b =>
                {
                    ...
                    b.Property<string>("GetPurchasesEndpoint")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("GetReversalsEndpoint")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
